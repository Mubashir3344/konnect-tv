      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-16 p-8 rounded-2xl glass-card text-center max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            Our service works with all popular streaming apps including Konnect TV App, TiviMate, 
            and many more. We'll send you detailed setup instructions for your device.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground">
            <span className="px-3 py-1.5 rounded-full bg-secondary">Konnect TV App</span>
