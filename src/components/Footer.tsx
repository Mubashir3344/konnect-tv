...
const InstagramIcon = () => <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
const YouTubeIcon = () => <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
  </svg>;
const WhatsAppIcon = () => <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
const socialLinks = [{
  ...
  name: "Facebook",
  href: "https://www.facebook.com/share/1K58Guteyr/",
  icon: FacebookIcon,
  hoverColor: "hover:text-blue-400 hover:bg-blue-400/10"
}, {
  name: "Instagram",
  href: "https://www.instagram.com/streamfluxtv?igsh=MWNmdTZqa3M4cWVjdA==",
  icon: InstagramIcon,
  hoverColor: "hover:text-pink-400 hover:bg-pink-400/10"
}, {
  name: "YouTube",
  href: "https://youtube.com/@streamflux12?si=_-c1pzGKCLg1T8MQ",
  icon: YouTubeIcon,
  hoverColor: "hover:text-red-400 hover:bg-red-400/10"
}];

const statsData = [
  { icon: Radio, label: "Live Channels", value: "50,000+" },
  { icon: Film, label: "Popular Movies", value: "100,000+" },
  { icon: Monitor, label: "TV Series", value: "80,000+" },
  { icon: Play, label: "TV Shows", value: "20,000+" },
];

const StatsSlider = () => {
  // Duplicate stats for seamless loop
  const duplicatedStats = [...statsData, ...statsData, ...statsData, ...statsData];
  
  return (
    <div className="w-full overflow-hidden bg-secondary/50 py-4 mb-8 rounded-xl">
...
const Footer = () => {
  ...
  return <footer className="py-16 border-t border-border/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map(social => <a key={social.name} href={social.href} target="_blank" rel="noopener noreferrer" className={`w-10 h-10 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground transition-all duration-300 ${social.hoverColor}`} aria-label={social.name}>
                  <social.icon />
                </a>)}
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#content" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Content
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="https://wa.me/12292997649" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-muted-foreground hover:text-green-400 transition-colors text-sm">
                  <MessageCircle className="w-4 h-4" />
                  WhatsApp: +1 (229) 299-7649
                </a>
              </li>
              <li>
