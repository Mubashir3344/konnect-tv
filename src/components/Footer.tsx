        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-10 h-10 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground transition-all duration-300 ${social.hoverColor}`}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:support@streamflux.tv" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors text-sm">
                  <Mail className="w-4 h-4" />
                  support@streamflux.tv
                </a>
              </li>
            </ul>
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="mt-6 inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-green-500 text-white font-medium text-sm hover:bg-green-600 transition-colors"
            >
              <WhatsAppIcon />
              Chat on WhatsApp
            </a>
